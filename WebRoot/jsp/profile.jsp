...
<body style="background-color:#f5f5f5">
	...
	<div class="my-body">
		...
		<div style="background-color:write">
			<div>
				<span>账号<input id="myaccount" class="form-control" type="text"
					placeholder="账号" readonly></span>
			</div>
			<br>
			<div>
				<span>用户名<input id="myusername" class="form-control" type="text"
					placeholder="名字"></span>
			</div>
			<br>
			<div>
				...
				<div class="bs-example">
					<div class="form-group">
						<label class="radio-inline "> <input type="radio"
							value="option1" id="sex-man" checked>男
						</label> <label class="radio-inline"> <input type="radio"
							value="option2" id="sex-woman">女
						</label> <label class="radio-inline"> <input type="radio"
							value="option3" name="sex-non">保密
						</label>
					</div>
				</div>
			</div>
			<br>
			<div>
				<span>等级<input class="form-control" type="text"
					placeholder="等级" readonly></span>
			</div>
			<br>
			<div>
				<span>邮箱<input class="form-control" type="text"
